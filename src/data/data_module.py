...
class CIFAR10DataModule:
    ...
    def __init__(self, 
        ...
        Args:
            ...
            randaugment_num_ops: Number of operations to apply in RandAugment
            randaugment_magnitude: Magnitude of operations in RandAugment
        """
        ...
        if self.use_randaugment:
            # RandAugment requires PIL images, not tensors
            base_transforms.append(RandAugment(num_ops=self.randaugment_num_ops, 
                                               magnitude=self.randaugment_magnitude))
            # Convert to tensor after RandAugment
            base_transforms.append(transforms.ToTensor())
        else:
            base_transforms.append(transforms.ToTensor())
        
        # Normalize and add random erasing
